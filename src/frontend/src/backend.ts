...
export class Backend implements backendInterface {
    ...
    async getMessagesByUser(arg0: string): Promise<ContactMessage> {
        if (this.processError) {
            try {
    ...
    async messageExists(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.messageExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async validateEmail(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.validateEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
